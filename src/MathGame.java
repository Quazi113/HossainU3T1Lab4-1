...
public class MathGame {
    ...
    private Player currentStreakPlayer;
    ...
    public String winningStreak() {
        if (player1 == winner) {
            ...
            System.out.println(player1.getName() + " has a winning streak of " + player1.winningStreak());
        } else if (player2 == winner) {
            player1.resetStreak();
            player3.resetStreak();
            player2.incrementStreak();
            System.out.println(player2.getName() + " has a winning streak of " + player2.winningStreak());
        } else {
            player1.resetStreak();
            player2.resetStreak();
            player3.incrementStreak();
            System.out.println(player3.getName() + " has a winning streak of " + player3.winningStreak());
        }
        return "";
    }
